...
<html>
  <body>
    <button onclick="startAudioConversation()">Start</button>
    <button onclick="closeStream()">Stop</button>
    <script>
      let recorder = null;
      let recordedBits = [];
      const ENDPOINT = "https://fast-tigers-fix-42-115-4-4.loca.lt/";

      const startAudioConversation = () => {
